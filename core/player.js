...
const player = {
	...
	refreshPlayerStats: function () {
		front.playerDiv.textContent = `Score: ${this.values.score} - Plis: ${
			this.values.plis
		} - Étape: ${this.stepNum + 1}/${
			aventure.listeDesEvenements.length
		} - HP: ${this.values.hp}/${this.values.hpMax} - Or: ${this.values.or}`;
	},
	resetRound: function () {
		this.values.round = 0;
	},
